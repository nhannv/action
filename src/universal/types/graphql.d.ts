...
export interface IUser {
  ...
  /**
   * all the offices the user is on that the viewer can see.
   */
...
export interface IOffice {
  ...
  /**
   * The user who approve checkin
   */
  approverId: string;
  approver: IUser;

  /**
   * The organization to which the office belongs
   */
  orgId: string;
  organization: IOrganization;

  /**
   * The datetime the office was created
   */
  createdAt: any;

  /**
   * The datetime the office was last updated
   */
  updatedAt: any | null;
}
...
export interface IMutation {
   ...
   * Create a new office
   */
  addOffice: IAddOfficePayload | null;
}
...
export interface IAddOfficeOnMutationArguments {
  /**
   * The new office object
   */
  newOffice: INewOfficeInput;
}
...
export interface INewOfficeInput {
  /**
  ...
  /**
   * The unique orginization ID that pays for the office
   */
  orgId?: string | null;

  /**
   * The unique user ID that response to approve checkin
   */
  approverId?: string | null;
}

export interface IAddOfficePayload {
  __typename: 'AddOfficePayload';
  error: IStandardMutationError | null;
  office: IOffice | null;
}
...
export type IntegrationSubscriptionPayload =
  | IAddProviderPayload
  | IRemoveProviderPayload;
